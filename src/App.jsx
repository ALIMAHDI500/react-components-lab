  ...
  return (
   <>
    ...
    <section>
      ...
      {weatherForecasts.map((weather,index)=>(<WeatherForecasts key= {index} day={weather.day} conditions={weather.conditions} 
       img= {weather.img} imgAlt= {weather.imgAlt}  time= {weather.time}/>))}
